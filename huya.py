#!/usr/bin/env python3
"""虎牙(huya.com)平台解析模块 —— iina-plus (Huya.swift / HuyaUrl.swift) 的 Python 复刻。
...
# 参数顺序模板(HuyaUrl.swift 里的 example,用来保持 query 参数顺序一致)
...
# ---- HuyaUrl.rotUid:uid 的 64bit 循环移位 ----
...
# ---- HuyaUrl.format:拼出带签名的 flv 地址(ratio=0 占位,后按码率替换)----
